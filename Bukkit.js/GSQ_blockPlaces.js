/*
  ブロックの配置
    QID: bjs:GSQ_pickupExpOrb:make:(回数1):(G-EXP報酬1),(回数2):(G-EXP報酬2), ...

*/

// 表示名
DISPLAY_LINE = "ブロックを{count}回 配置する";
...
function getIcon(api, icon) {
    ...
    icon.icon = Java.type("org.bukkit.Material").BRICKS;
    icon.category = "blockplaces";
    return null;
}
